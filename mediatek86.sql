...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 27 mars 2026 à 14:50
...
('00030', '2024-03-01', '10002'),
('00050', '2026-04-15', '10003'),
('55555', '2026-05-22', '10006');
...
('00020', '2026-03-18', 50),
('00022', '2026-03-26', 50),
('00025', '2026-03-25', 100),
('00030', '2020-11-01', 50),
('00033', '2026-03-26', 50),
('00040', '2026-03-01', 80),
('00050', '2026-03-01', 120),
('00055', '2026-03-26', 100),
('00060', '2026-03-25', 133),
('00123', '2026-03-26', 90),
('55555', '2026-03-26', 90),
('66666', '2026-03-26', 80),
('77777', '2026-03-26', 50),
...
('00005', 7, '00004', '00001'),
('00022', 5, '00008', '00003'),
('00025', 10, '00025', '00003'),
('00033', 4, '00025', '00003'),
('00055', 10, '00008', '00003'),
('00060', 12, '20002', '00001'),
('00123', 8, '00006', '00002'),
('66666', 8, '00008', '00003');
...
DELIMITER $$
CREATE TRIGGER `after_livraison` AFTER UPDATE ON `commandedocument` FOR EACH ROW BEGIN
    DECLARE i INT DEFAULT 1;
    DECLARE maxNumero INT DEFAULT 0;
    
    -- on vérifie que le nouveau suivi est livrée
    IF NEW.idSuivi = '00003' AND OLD.idSuivi != '00003' THEN
    
        -- on récupère le numéro d'exemplaire max pour ce livre
        SELECT MAX(numero) INTO maxNumero
        FROM exemplaire
        WHERE id = NEW.idLivreDvd;
        
        -- si pas d'exemplaires, on commence à 0
        IF maxNumero IS NULL THEN
            SET maxNumero = 0;
        END IF;
        
        -- on crée autant d'exemplaires que nbExemplaire
...
('00008', 1, '2026-03-26', '', '00001'),
('00008', 2, '2026-03-26', '', '00001'),
('00008', 3, '2026-03-26', '', '00001'),
('00008', 4, '2026-03-26', '', '00001'),
('00008', 5, '2026-03-26', '', '00001'),
('00008', 6, '2026-03-26', '', '00001'),
('00008', 7, '2026-03-26', '', '00001'),
('00008', 8, '2026-03-26', '', '00001'),
('00008', 9, '2026-03-26', '', '00001'),
('00008', 10, '2026-03-26', '', '00001'),
('00008', 11, '2026-03-26', '', '00001'),
('00008', 12, '2026-03-26', '', '00001'),
('00008', 13, '2026-03-26', '', '00001'),
('00008', 14, '2026-03-26', '', '00001'),
('00008', 15, '2026-03-26', '', '00001'),
('00008', 16, '2026-03-26', '', '00001'),
('00008', 17, '2026-03-26', '', '00001'),
('00008', 18, '2026-03-26', '', '00001'),
('00008', 19, '2026-03-26', '', '00001'),
('00008', 20, '2026-03-26', '', '00001'),
('00008', 21, '2026-03-26', '', '00001'),
('00008', 22, '2026-03-26', '', '00001'),
('00008', 23, '2026-03-26', '', '00001'),
('00025', 1, '2026-03-25', '', '00001'),
('00025', 2, '2026-03-25', '', '00002'),
('00025', 3, '2026-03-25', '', '00001'),
('00025', 4, '2026-03-25', '', '00002'),
('00025', 5, '2026-03-25', '', '00003'),
('00025', 6, '2026-03-25', '', '00002'),
('00025', 7, '2026-03-25', '', '00002'),
('00025', 8, '2026-03-25', '', '00002'),
('00025', 9, '2026-03-25', '', '00002'),
('00025', 11, '2026-03-26', '', '00001'),
...
('10011', 509, '2021-07-01', '', '00002'),
('10011', 510, '2021-08-04', '', '00001'),
('10011', 511, '2021-09-01', '', '00001'),
('10011', 512, '2021-10-06', '', '00001'),
('10011', 513, '2021-11-01', '', '00001'),
('20002', 1, '2026-03-26', '', '00001'),
('20002', 2, '2026-03-26', '', '00001'),
('20002', 3, '2026-03-26', '', '00002'),
('20002', 4, '2026-03-26', '', '00001'),
('20002', 5, '2026-03-26', '', '00001'),
('20002', 6, '2026-03-26', '', '00001'),
('20002', 7, '2026-03-26', '', '00001');
...
('admin', 'adminpwd', '00001'),
('prets', 'pretspwd', '00002'),
('culture', 'culturepwd', '00003');
